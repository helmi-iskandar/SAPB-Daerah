        ...
        <div class="card-body">
            <div class="d-flex d-lg-flex d-md-block align-items-center">
                <div>
                    ...
                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Nota Dinas Pengajuan</h6>
                </div>
        ...
        <div class="card-body">
            <div class="d-flex d-lg-flex d-md-block align-items-center">
                <div>
                    ...
                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Pertanggungjawaban Dalam Proses
                    </h6>
                </div>
                <div class="ml-auto mt-md-3 mt-lg-0">
        ...
        <div class="card-body">
            <div class="d-flex d-lg-flex d-md-block align-items-center">
                <div>
                    ...
                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Pertanggungjawaban Selesai</h6>
                </div>
                <div class="ml-auto mt-md-3 mt-lg-0">
...
<div class="row">
    <div class="col-lg-4 col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Grafik Pertanggungjawaban</h4>
    ...
    <div class="col-lg-4 col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Pertanggungjawaban Selesai</h4>
    ...
    <div class="col-lg-4 col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4">Penyerapan Anggaran</h4>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-start">
                    <h4 class="card-title mb-0">Grafik Penyerapan Anggaran</h4>
                    <div class="ml-auto">
                ...
                <ul class="list-inline text-center mt-4 mb-0">
                    <li class="list-inline-item text-muted font-italic">Grafik Penyerapan Anggaran</li>
                </ul>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\skripsi\SIBELA\resources\views/index.blade.php ENDPATH**/ ?>